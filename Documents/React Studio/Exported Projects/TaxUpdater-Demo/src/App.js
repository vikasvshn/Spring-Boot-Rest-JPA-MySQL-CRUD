    ...
    const makeScreen = (screenId, baseProps, atTop, forward, subpathId) => {
      ...
      switch (screenId) {
        case 'start':
          ...
          break;
        case 'screen2':
          screen = <Screen2 {...baseProps} />;
          break;
        case 'login1':
          screen = <Login1Screen {...baseProps} />;
          break;
        default:
          screen = null;
      }
      ...
      <div className="App">
        <Switch>
          ...
          <Route path="/screen2" render={(props) => {
            return makeScreen('screen2', props.location.state, true, true);
          }} />
          <Route path="/login1" render={(props) => {
            return makeScreen('login1', props.location.state, true, true);
          }} />
        </Switch>
      </div>
    );
